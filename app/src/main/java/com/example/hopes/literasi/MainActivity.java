...
public class MainActivity extends AppCompatActivity {
    ...
    public class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int pos, View view, ViewGroup viewGroup) {
            ...
            txtName.setTextColor(getResources().getColor(R.color.textcolor));
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL="http://freefreedot.store/literasi/";
        //private static final String PDF_SITE_URL="http://192.168.0.206/literasi/";
            ...
            AndroidNetworking.get(PDF_SITE_URL)
                    ...
                    .getAsJSONArray(new JSONArrayRequestListener() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            {
                                myProgressBar.setVisibility(View.GONE);
                                Toast.makeText(c, "Mohon Periksa Koneksi Anda"+e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                        //ERROR
                        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuth = FirebaseAuth.getInstance();
         ...
         btnRetrieve= findViewById(R.id.downloadBtn);
        ...
        btnRetrieve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                btnRetrieve.setCursorVisible(false);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.profil :
                startActivity(new Intent(MainActivity.this, MenuSiswa.class));
                break;
            case R.id.logout :
                Logout();
                break;
            case R.id.refreshMenu2:
                onRestart();
                break;
        }
